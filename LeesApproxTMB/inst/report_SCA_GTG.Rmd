...
if(any(info$data$CAL_n > 0, na.rm = TRUE)) {
ind_valid <- rowSums(info$data$CAL_hist, na.rm = TRUE) > 0
plot_composition(info$Year[ind_valid], info$data$CAL_hist[ind_valid, ], TMB_report$CALpred[ind_valid, ], CAL_bins = info$data$LenMids, plot_type = "bubble_data")
}
```
...
if(any(info$data$CAL_n > 0, na.rm = TRUE)) {
ind_valid <- rowSums(info$data$CAL_hist, na.rm = TRUE) > 0
plot_composition(info$Year[ind_valid], info$data$CAL_hist[ind_valid, ], TMB_report$CALpred[ind_valid, ], CAL_bins = info$data$LenMids, plot_type = "annual", N = info$data$CAA_n[ind_valid])
}
```
